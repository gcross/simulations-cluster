-- @+leo-ver=4-thin
-- @+node:gcross.20100211100316.1267:@thin simulate-cluster.hs
-- @@language Haskell

-- @<< Language extensions >>
-- @+node:gcross.20100211100316.1268:<< Language extensions >>
{-# LANGUAGE ScopedTypeVariables #-}
-- @-node:gcross.20100211100316.1268:<< Language extensions >>
-- @nl

-- @<< Import needed modules >>
-- @+node:gcross.20100211100316.1269:<< Import needed modules >>
import Acme.Dont
...
-- @+others
-- @+node:gcross.20100211100316.1270:Operator tensors
...
-- @-node:gcross.20100211100316.1270:Operator tensors
-- @+node:gcross.20100211100316.1271:analyzeTrialEnergies
...
-- @-node:gcross.20100211100316.1271:analyzeTrialEnergies
-- @+node:gcross.20100211100316.1272:main
main = do
    args <- getArgs
    ...
    -- @    << Define callbacks >>
    -- @+node:gcross.20100211100316.1273:<< Define callbacks >>
    ...
    -- @    << Run simulation >>
    -- @+node:gcross.20100211100316.1274:<< Run simulation >>
